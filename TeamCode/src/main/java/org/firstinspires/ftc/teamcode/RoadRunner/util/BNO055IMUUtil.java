...
public class BNO055IMUUtil {
   ...
   * <p>
   * Adapted from <a
   * href="https://ftcforum.firstinspires.org/forum/ftc-technology/53812-mounting-the-revhub-vertically?p=56587#post56587">this
   * post</a>. Reference the <a
   * href="https://www.bosch-sensortec.com/media/boschsensortec/downloads/datasheets/bst-bno055-ds000.pdf">BNO055
  ...
  public static void swapThenFlipAxes(BNO055IMU imu, AxesOrder order, AxesSigns signs) {
    try {
      ...
      if (indices[0] == indices[1] || indices[0] == indices[2] || indices[1] == indices[2]) {
        throw new InvalidAxisRemapException(
            "Same axis cannot be included in AxesOrder twice");
      }
  ...
  /**
   * Now deprecated due to unintuitive parameter order. Use {@link #swapThenFlipAxes} or
   * {@link #remapZAxis} instead.
   *
   * @param imu   IMU
   * @param order axes order
   * @param signs axes signs
