...
public class ManualFeedforwardTuner extends LinearOpMode {
  ...
  private static MotionProfile generateProfile(boolean movingForward) {
    ...
    return MotionProfileGenerator.generateSimpleMotionProfile(start, goal, DriveConstants.MAX_VEL,
      ...
      switch (mode) {
        case TUNING_MODE:
          ...
          double targetPower = Kinematics.calculateMotorFeedforward(motionState.getV(),
              motionState.getA(), DriveConstants.kV, DriveConstants.kA, DriveConstants.kStatic);
