...
public class PIDFCoefficients {
     ...
     * @param maxIntegralSum The maximum integral sum for windup prevention (Recommended that for
     *                       FTC maxIntegralSum * ki ~= 0.25)
     * @param lowPassGain The filtering value in the range 0 < a < 1
     */
    public PIDFCoefficients(double kp, double ki, double kd, double kf, double maxIntegralSum, double lowPassGain) {
        this.kp = kp;
        this.ki = ki;
        this.kd = kd;
        this.kf = kf;
